				...
				<table class="table_working_hours">
		        	<tbody>
							    ...
							    <tr class="opened">
									...
									<td class="day_value closed"><span><input type="date" name="dob" class="form-control" value="<?php echo $r["dob"]; ?>" required></span></td>
								</tr>
								<tr class="opened">
								...
								<tr class="opened">
									...
									<option value="<?php echo $r["religion"]; ?>"><?php echo $r["religion"]; ?></option>
					                    ...
					                    <option value="Yudhi">Yudhi</option>
								...
								<tr class="opened">
									<td class="day_label">Ocupation :</td>
									<td class="day_value closed"><span></span>
									<select class="form-control" name="ocupation">
									<option value="<?php echo $r["ocupation"]; ?>"><?php echo $r["ocupation"]; ?></option>
